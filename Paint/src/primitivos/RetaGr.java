...
public class RetaGr extends Reta{
	...
	public void desenharRetaMidPoint(GraphicsContext g,double mult){

		int x1 = (int)(getP1().getX()*mult), x2 = (int)(getP2().getX()*mult);
		int y1 = (int)(getP1().getY()*mult), y2 = (int)(getP2().getY()*mult);
		int dx, dy, i, d;
		int incx, incy, inc1, inc2;
		int x,y;
